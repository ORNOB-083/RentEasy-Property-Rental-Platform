...
export default function Navbar() {
    ...
    const showSkeleton = isPending && !hasLoadedOnce;
                ...
                <div className="hidden items-center gap-3 md:flex">
                    ...
                    >
                        <div className="relative h-5 w-5 flex items-center justify-center overflow-hidden">
                            <Sun className="absolute h-5 w-5 transition-all duration-500 ease-in-out translate-y-0 opacity-100 rotate-0 dark:translate-y-10 dark:opacity-0 dark:rotate-90" />
                            <Moon className="absolute h-5 w-5 transition-all duration-500 ease-in-out -translate-y-10 opacity-0 -rotate-90 dark:translate-y-0 dark:opacity-100 dark:rotate-0" />
                        </div>
                    </button>

                    {showSkeleton ? (
                        <div className="flex items-center gap-3">
                            <div className="h-9 w-9 rounded-full bg-[#9B4DCA]/10 dark:bg-[#8B5CF6]/10 animate-pulse" />
                            <div className="h-9 w-28 rounded-full bg-[#9B4DCA]/10 dark:bg-[#8B5CF6]/10 animate-pulse" />
                        </div>
                    ) : isLoggedIn ? (
                        <>
                            <button
                ...
                <div className="flex items-center gap-2 md:hidden">
                    ...
                    >
                        <div className="relative h-4 w-4 flex items-center justify-center overflow-hidden">
                            <Sun className="absolute h-4 w-4 transition-all duration-500 translate-y-0 opacity-100 rotate-0 dark:translate-y-8 dark:opacity-0 dark:rotate-90" />
                            <Moon className="absolute h-4 w-4 transition-all duration-500 -translate-y-8 opacity-0 -rotate-90 dark:translate-y-0 dark:opacity-100 dark:rotate-0" />
                        </div>
                    </button>
                    ...
                    <button
                        ...
                        className="rounded-full border border-[#E5E7EB] dark:border-[#2D2140] p-2 text-[#1A1528] transition-colors hover:bg-[#9B4DCA]/5 dark:hover:bg-[#8B5CF6]/10"
                    >
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        {showSkeleton ? (
                            <div className="mt-4 flex flex-col gap-3 border-t border-[#E5E7EB] pt-4 dark:border-[#2D2140]">
                                <div className="h-10 w-full rounded-full bg-[#9B4DCA]/10 dark:bg-[#8B5CF6]/10 animate-pulse" />
                            </div>
                        ) : isLoggedIn ? (
                            <div className="mt-4 flex flex-col gap-3 border-t border-[#E5E7EB] pt-4 dark:border-[#2D2140]">
