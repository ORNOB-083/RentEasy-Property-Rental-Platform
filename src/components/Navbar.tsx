            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
                ...
                <Link href="/" className="flex items-center gap-3">
                    ...
                    <span className="text-3xl font-bold text-[#1A1528] dark:text-[#F5F3FF] transition-colors">
                        RentEasy<span className="text-[#9B4DCA] dark:text-[#8B5CF6]">BD</span>
                    </span>
                </Link>
                ...
                <div className="hidden items-center gap-3 md:flex">
                    ...
                    {isLoggedIn ? (
                        <>
                            ...
                            <Link
                                href="/dashboard"
                                className="flex items-center gap-2 rounded-full border border-[#E5E7EB] dark:border-[#2D2140] px-4 py-2 text-[15px] font-medium text-[#1A1528] transition-all duration-200 hover:border-[#9B4DCA] hover:bg-[#9B4DCA]/5 active:scale-95 dark:text-[#F5F3FF]"
                            >
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="mt-4 flex flex-col gap-3 border-t border-[#E5E7EB] pt-4 dark:border-[#2D2140]">
                            {isLoggedIn ? (
                                <Link
                                    href="/dashboard"
                                    className="flex-1 rounded-full border border-[#E5E7EB] py-2.5 text-center text-[15px] font-medium text-[#1A1528] transition-colors hover:bg-[#9B4DCA]/5 dark:border-[#2D2140] dark:text-[#F5F3FF] dark:hover:bg-[#8B5CF6]/10"
                                >
                                    Dashboard
                                </Link>
                            ) : (
