...
export default function RegisterForm({ redirectTo = "/" }: { redirectTo?: string }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success("Account created successfully! Welcome to RentEasy BD.");
                ...
                <div className="w-full md:w-1/2 bg-[#9B4DCA]/5 dark:bg-[#8B5CF6]/10 p-8 md:p-12 flex flex-col items-center justify-center text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <h2 className="text-3xl font-bold text-[#1A1528] dark:text-[#F5F3FF] mb-2">
                            Join <span className="text-[#9B4DCA] dark:text-[#8B5CF6]">RentEasy BD</span>
                        </h2>
                        <p className="text-[#585470] dark:text-[#A79FBB] text-lg max-w-sm">
                            Find your dream home or list your property. It&apos;s easy, fast, and trusted across Dhaka.
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-14">
                    <div className="max-w-md mx-auto">
                        ...
                        <p className="text-[#585470] dark:text-[#A79FBB] mb-6 text-sm">
                            ...
                            <Link href="/login" className="text-[#9B4DCA] dark:text-[#8B5CF6] font-medium hover:underline ml-1">
                                Log in
                            </Link>
                        </p>
